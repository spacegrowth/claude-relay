...
| 43 | CAP | **executor_fallback_model** — configured overload-fallback per executor via the per-launch --settings file (`fallbackModel` works interactively; the flag is print-only); user-chosen direction + visible notice, instead of wherever ✅ LANDED on main 2026-08-22 (unreleased) | README Config |
