...
| 40 | CAP | **executor_default_context config** — the window an executor gets when nothing else decides it; shipped **1m** (window is a ceiling not consumption); packet `CONTEXT: 200k` opts down, haiku always 200k ✅ LANDED on main 2026-08-21 (unreleased) | README Config |
